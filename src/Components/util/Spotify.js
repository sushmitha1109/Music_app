const clientId = "4343d2baf4f94eaea127d4401cda2081";
...
const Spotify ={
    ...
    return fetch("https://api.spotify.com/vl/search?type=tracking=$(term)",{
        headers:{
    ...
    savedPlaylist(name,trackUris){
        ...
        .then(jsonResponse=>{
            ...
            .then(jsonResponse=>{
                ...
                return fetch(
                    "https://api.spotify.com/v1/user/${userid}/playlists/${playlistIs}/tracks",
                    {
                        headers:headers,
                        method:"POST",
